                    ...
                    <tbody>
                        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                ...
                                <td><?php echo $row['b_create'] ?></td>
                                <td><?php echo $row['emp_id'] ?></td>
                                <?php if ($row['status'] = 'decline') { ?>
                                    <td><button class="btn btn-danger">คำขอร้องนี้ถูกปฎิเสธ</button></td>
                                <?php } else { ?>
                                    <td>
